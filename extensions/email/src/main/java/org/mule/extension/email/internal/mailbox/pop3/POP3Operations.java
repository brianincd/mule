...
public class POP3Operations {
   ...
   *         {@link BaseEmailAttributes}.
   */
  @Summary("List all the emails in the given POP3 Mailbox Folder")
  public PagingProvider<MailboxConnection, OperationResult<Object, POP3EmailAttributes>> listPop3(@UseConfig POP3Configuration config,
