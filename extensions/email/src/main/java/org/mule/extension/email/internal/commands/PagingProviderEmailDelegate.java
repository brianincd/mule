...
public final class PagingProviderEmailDelegate<T extends BaseEmailAttributes>
  ...
  private final CloseMailboxDelegate closeDelegate;
   ...
   * @param closeDelegate callback for closing folder and doing the proper cleanup after retrieving the emails
   */
  public PagingProviderEmailDelegate(MailboxAccessConfiguration configuration, String folderName,
                                     ...
                                     CloseMailboxDelegate closeDelegate) {
  ...
  @FunctionalInterface
  public interface CloseMailboxDelegate {
