...
import static org.mule.extension.jms.internal.support.LookupJndiDestination.ALWAYS;
...
public class Jms102bSupport extends Jms11Support
{
    ...
    {
        if (getLookupJndiDestination().equals(ALWAYS) || getLookupJndiDestination().equals(LookupJndiDestination.TRY_ALWAYS) )
        {
            try
            {
