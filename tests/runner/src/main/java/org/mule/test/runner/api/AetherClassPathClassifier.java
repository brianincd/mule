...
public class AetherClassPathClassifier implements ClassPathClassifier {
   ...
   * <p/>
   * {@value #SERVICE_PROVIDER_CLASS_NAME} will be used as
   * {@link org.mule.runtime.module.artifact.classloader.ArtifactClassLoader#getArtifactName()}
   * <p/>
  ...
  /**
   * Collects from the list of directDependencies {@link Dependency} those that are classified with classifier especified.
   *
